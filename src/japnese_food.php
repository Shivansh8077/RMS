...
$select_indian_food_name_query = "select * from food_items WHERE type='jap'";
    ...
    <div class="row">
        ...
        <div class='col-sm-4' >
            ...
            if (!isset($_SESSION['email'])) {
                ...
                <form method='get' action='japnese_food.php' id='form'>Choose Quantity <input type='number' min="1" max="5" placeholder='Enter Quantity' value="1" name='inputQuantity' style="height: auto;width: 25%;margin-top: 15px">
                    <input type="submit" value="Confirm Quantity" class="purple_button">
                </form>
                <?php
                $inputQuantity = 1;
                $page_name = "japnese_food.php";
